...
public class ArticleDetailFragment extends Fragment implements
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        AppCompatActivity hostActivity = (AppCompatActivity) this.getActivity();
        if (hostActivity != null) {
            ...
            throw new ClassCastException("Can't find parent activity");
        }
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mCollapsingToolbar = (CollapsingToolbarLayout) mRootView.findViewById(R.id.collapsing_toolbar_layout);

        mToolbar = (Toolbar) mRootView.findViewById(R.id.detail_activity_toolbar);
